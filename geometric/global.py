...
# Controls
gif_path = "visualizations/geometric_global/"
CREATE_GIF = False
SEED = 1
...
def main():
	...
	flock = Flock(2, N_AGENTS, [k_p, k_d], SEED)
...
class Flock(agents.Agents):
	def __init__(self, N_INT, N_AGENTS, gains, SEED):
	...
	def control(self, i):
		"""
		This control law is based on the absolute target position and velocity.
		"""
		# Relative pose
		...
		u_i = -self.k_p * rel_pose - self.k_d * rel_velocity
