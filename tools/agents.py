...
class Agents:
    def __init__(self, N_INT, N_AGENTS, D_MIN=5, D_MAX=25, R_MAX=30, dt=0.1):
    ...
    def save_data(self):
        ...
        self.vel.append(np.array(self.V))

class SubgraphAgents(Agents):
    def __init__(self, N_INT, N_AGENTS, SEED, T_VEC=[20,20,0]):
        super().__init__(N_INT, N_AGENTS)
        self.SEED = SEED
        self.T_VEC = T_VEC
